...
<main class="app flex flex-row p-9 gap-8 h-full w-full m-0 bg-[#FFF9FC]">
	<aside class="w-20 h-full flex flex-col px-4 py-7 gap-2 bg-[#461D47] color-white rounded-xl">
